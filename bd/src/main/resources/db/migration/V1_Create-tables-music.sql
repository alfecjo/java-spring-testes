...
CREATE TABLE gravadora (
    cod_gravadora SERIAL PRIMARY KEY,
...
CREATE TABLE gravacao (
    cod_gravacao SERIAL PRIMARY KEY,
...
INSERT INTO cantor (cod_cantor, nome_cantor, pais) VALUES (2, '!', 'Inglaterra');
